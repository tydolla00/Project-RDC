...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchemaHash": "ec55f720ce41979678f3517b5613e8920c1f83f42797508a1ccae03710481267",
  "copyEngine": true,
  "runtimeDataModel": {
    "models": {},
    "enums": {},
...
/**
  ...
  /**
   * `prisma.sessionEditRequest`: Exposes CRUD operations for the **SessionEditRequest** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more SessionEditRequests
    * const sessionEditRequests = await prisma.sessionEditRequest.findMany()
    * ```
    */
  get sessionEditRequest(): Prisma.SessionEditRequestDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.sessionRevision`: Exposes CRUD operations for the **SessionRevision** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more SessionRevisions
    * const sessionRevisions = await prisma.sessionRevision.findMany()
    * ```
    */
  get sessionRevision(): Prisma.SessionRevisionDelegate<ExtArgs, { omit: OmitOpts }>;
}
